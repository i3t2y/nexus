...
- `i3t2y/nexus` — Hermes Agent space (Python, HF Bucket mount, subprocess gateway+dashboard, keepalive daemon)
- `i3t2y/n-nmem` — mem0 server deployment (Python, uvicorn single process, HF Dataset hot-reload, Neon pgvector)
